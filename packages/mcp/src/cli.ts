/**
 * CLI entry point for `@dappql/mcp`. Invoked by `bin/dappql-mcp.js`.
 *
 * This file has side effects (it loads .env, calls process.exit on failure,
 * boots a server). Do NOT import it from library code — use `index.ts`
 * exports instead. Only the bin script should import this.
 */
